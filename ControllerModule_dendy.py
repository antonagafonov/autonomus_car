...
class JoystickController(threading.Thread):
    ...
    def handle_button_press(self, button):
        ...
        elif button == 2:  # Button 2 pressed (backward)
            print("Button 2 pressed: Backward ON")
    ...
    def handle_button_release(self, button):
        ...
        elif button == 2:  # Button 2 released (backward off)
            print("Button 2 released: Backward OFF")
    ...
    def handle_axis_motion(self, axis, value):
        ...
        if axis == 0:  # Axis 0 for steering control
            ...
            if value < -0.5:  # Left steering
                self.state["steering"] = -1
            elif value > 0.5:  # Right steering
                self.state["steering"] = 1
            else:  # Centered steering
